...
public class TickProgressBar extends ProgressBar {
    ...
    public TickProgressBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        @SuppressLint("Recycle") final TypedArray attributes = getContext().obtainStyledAttributes(attrs, R.styleable.TickProgressBar);
        ...
        int DEFAULT_TEXT = spToPx(getContext(), 20);
